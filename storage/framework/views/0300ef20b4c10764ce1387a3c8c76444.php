...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted mb-0">
            Customer: <?php echo e($order->user->name ?? 'Guest'); ?> ·
        ...
        <div class="card card-soft">
            <div class="card-body">
                ...
                <p>
                    ...
                    <?php echo e($order->rider->name ?? 'Not assigned yet'); ?>
                ...
                <?php if($order->delivered_at): ?>
                    <p>
                        ...
                        <?php echo e($order->delivered_at->format('M d, Y h:i A')); ?>
                ...
                <div class="d-grid gap-2">
                    <?php if($order->status === 'pending'): ?>
                        <form method="POST" action="<?php echo e(route('admin.orders.approve', $order)); ?>">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PATCH'); ?>
                        ...
                        <form method="POST" action="<?php echo e(route('admin.orders.reject', $order)); ?>">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PATCH'); ?>
            ...
            <div class="card card-soft mt-4" id="delivery-proof">
                ...
                <div class="card-body">
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo e($order->delivery_proof_url); ?>" target="_blank" class="btn btn-outline-primary mb-3">
                            Open Proof File
                        </a>
                    <?php endif; ?>

                    <p class="mb-1"><strong>Uploaded by:</strong> <?php echo e($order->rider->name ?? 'N/A'); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leeji\Downloads\food-ordering-system-BASE64-PROOF-FIX-ALL\base64fix\resources\views/admin/orders/show.blade.php ENDPATH**/ ?>