...
<form method="POST" action="{{ route('login') }}">
    ...
    <div class="mb-3">
        ...
        <input name="email" type="email" value="{{ old('email') }}" class="form-control" required autofocus autocomplete="username">
    </div>
    <div class="mb-3">
...
<p class="text-center mt-4 mb-0">
    No account yet? <a href="{{ route('register') }}">Create account</a>
</p>
@endsection
